...
std_print "Generating standalone application source files inside src/..."

# 1. Generate the absolute minimal overhead baseline profile
cat << 'EOF' > src/BaselineNoWorkMain.cpp
#include <print>
#include <cstdint>
#include <chrono>
#include <thread>
...
# 2. Generate the multi-threaded CME SBE engine decoder profile
cat << 'EOF' > src/CmeSbeDemoMain.cpp
#include <print>
#include <cstdint>
#include <chrono>
#include <thread>
...
std_print "Source files injected into src/ successfully."